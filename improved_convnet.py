...
class ImprovedConvNet(torch.nn.Module):
    def __init__(self):
        ...
        self.block_1_2 = torch.nn.Conv2d(in_channels=32, out_channels=32, kernel_size=3)
        ...
        self.block_2_2 = torch.nn.Conv2d(in_channels=64, out_channels=64, kernel_size=3)
        ...
        self.block_3_2 = torch.nn.Conv2d(in_channels=128, out_channels=128, kernel_size=3)
        self.block_3_3 = torch.nn.Conv2d(in_channels=128, out_channels=256, kernel_size=3)

        self.block_4_1 = torch.nn.Conv2d(in_channels=256, out_channels=256, kernel_size=3)
        self.block_4_2 = torch.nn.Conv2d(in_channels=256, out_channels=256, kernel_size=3)
        self.block_4_3 = torch.nn.Conv2d(in_channels=256, out_channels=128, kernel_size=3)

        self.fc_1 = torch.nn.Linear(in_features=12800, out_features=1)
